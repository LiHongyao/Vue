...
<div id="app">
    ...
    <p v-if="name.indexOf('Henrry') >= 0">Hello, {{ name }}!</p>
</div>
```
...
[查看demo](https://lihongyao.github.io/tutorials/vue/01.GettingStarted/v-if.html)
...
[查看demo](https://lihongyao.github.io/tutorials/vue/01.GettingStarted/key.html)
